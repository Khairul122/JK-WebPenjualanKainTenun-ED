            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        ...
                        <div class="ml-auto font-medium">6750527090 / OLIVIA SECONDBRAND</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">1918009817 / OLIVIA SECONDBRAND</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">6721598021 / OLIVIA SECONDBRAND</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                ...
                <div class="box p-5 mt-5">
                    <div class="flex">
                        ...
                        <div class="font-medium">Sub Total : Rp. <?= number_format($this->cart->total(), 0, ',', '.') ?></div>
                    </div>
                    <div class="flex mt-4">
                        <div class="mr-auto"><?php echo $this->lang->line('discount'); ?></div>
                        <div class="font-medium text-danger">Discount : Rp. 0</div>
                    </div>
                    <div class="flex mt-4">
                        <div class="mr-auto"><?php echo $this->lang->line('tax'); ?></div>
                        <div class="font-medium">Tax : Rp. 0</div>
                    </div>
                    <div class="flex mt-4 pt-4 border-t border-slate-200/60 dark:border-darkmode-400">
                        <div class="mr-auto font-medium text-base"><?php echo $this->lang->line('total_charge'); ?></div>
                        <div class="font-medium text-base"><strong>Total Charge = Rp. <?= number_format($this->cart->total(), 0, ',', '.') ?>,-</strong></div>
                    </div>
                </div>
            </div>
        </div>
